...
export function TerminosPage({ go }: Props) {
  return (
    <div style={{ maxWidth: 760, margin: '0 auto', padding: '48px 28px' }}>
      ...
      <p style={p}>
        Al acceder y utilizar FletApp (la "Plataforma"), usted ("el Usuario") acepta quedar
        ...
        deberá abstenerse de usar la Plataforma. El uso continuado de FletApp constituye su
        aceptación expresa de estos términos y de las actualizaciones que se publiquen.
      </p>

      <h2 style={h2}>2. Descripción del servicio</h2>
      <p style={p}>
        FletApp es una plataforma tecnológica que permite a los Usuarios cotizar, agendar,
        rastrear y facturar envíos de flete terrestre en México. FletApp actúa exclusivamente
      ...
      <p style={p}>
        ...
        transportista correspondiente. FletApp no garantiza la disponibilidad permanente de
      ...
      <p style={p}>
        FletApp ofrece distintos planes de suscripción: Gratis, Pro y Empresa. Los planes de pago
      ...
      <p style={p}>
        ...
        documentación de la carga, incluyendo la Carta Porte cuando resulte exigible. FletApp no
      ...
      <p style={p}>
        En la máxima medida permitida por la ley, FletApp no será responsable por daños
        indirectos, incidentales, especiales o consecuenciales, ni por lucro cesante derivado del
        uso o imposibilidad de uso de la Plataforma. La responsabilidad total de FletApp, en su
      ...
      <p style={p}>
        ...
        software, marcas, logotipos, diseños, textos y contenidos, son propiedad de FletApp o de
      ...
      <p style={p}>
        FletApp podrá suspender o cancelar el acceso del Usuario a la Plataforma, de manera total o
        parcial, en caso de incumplimiento de estos términos, uso fraudulento o por requerimiento
        legal. El Usuario podrá dar por terminada su relación con FletApp cancelando su cuenta en
        cualquier momento.
      </p>

      <h2 style={h2}>11. Modificaciones</h2>
      <p style={p}>
        FletApp se reserva el derecho de modificar estos Términos y Condiciones en cualquier
        momento. Las modificaciones serán publicadas en la Plataforma y entrarán en vigor a partir
        de su publicación. El uso continuado de FletApp tras dichas modificaciones implica la
      ...
      <p style={p}>
        ...
        Condiciones, puede comunicarse con nosotros al correo electrónico legal@fletapp.mx.
      </p>
    </div>
  )
}
