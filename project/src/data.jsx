...
// route geometry (in % of map canvas) — CDMX -> Monterrey
const ROUTE_CDMX_MTY = [
  { x: 52, y: 80, city: 'Ciudad de México', type: 'origin' },
  { x: 48, y: 64, city: 'Querétaro' },
  { x: 43, y: 54, city: 'Irapuato' },
  { x: 41, y: 42, city: 'Aguascalientes' },
  { x: 58, y: 18, city: 'Monterrey', type: 'dest' },
];
...
const fmtUSD = (n) => '$' + n.toLocaleString('en-US', { minimumFractionDigits: n % 1 ? 2 : 0, maximumFractionDigits: 2 });
...
Object.assign(window, { SHIPMENTS, QUOTES, ROUTE_CDMX_MTY, TIMELINE, fmtUSD, INVOICES, TICKET });
